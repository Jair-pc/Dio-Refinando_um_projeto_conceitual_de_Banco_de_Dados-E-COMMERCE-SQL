...
Insert into Physical_person (Complet_name, CPF)
		Values ('Jair Pereira', 159263487),
			   ('Silvia Pilar Moreira', 123456789),
               ('Pedro Henrique Moreira', 789456123),
               ('Anderson Alisson Rodrigues', 147258036),
               ('Angelo Salles', 753420196),
               ('Claudio Duarte', 456789120),
               ('Antonio Fabio de Souza', 852410697);
